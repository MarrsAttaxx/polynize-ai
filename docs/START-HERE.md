...
| Know what a console function does / how to use it | **`pam-console/user-manual.md`** — the master reference for every shipped function |
| Track what still needs verifying in the running console | **`pam-console/testing-checklist.md`** — the living QA tracker |
